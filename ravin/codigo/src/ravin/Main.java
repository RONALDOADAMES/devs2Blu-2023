...
public class Main {
	...
	private static int mostrarMenuFuncionariosAlterar(List<Funcionario> funcionarios) {
	...
	private static Funcionario mostrarMenuAlterarFuncionario(Funcionario funcionarioAlterar) {
		funcionarioAlterar.setRg(JOptionPane.showInputDialog("Digite o RG do funcionário:"));
		...
		funcionarioAlterar.setPis(Integer.parseInt(JOptionPane.showInputDialog("Digite o PIS do funcionário")));
		funcionarioAlterar.setDataAdmissao(new Date());
