...
public class Main {
	...
	public static Cliente cadastrarCliente() {
		...
		cliente.setVip(Boolean.parseBoolean(JOptionPane.showInputDialog("O cliente está Vip? \n 0 - Não \n 1 - Sim]")));
	...
	public static Pedido cadastrarPedido() {
		...
		pedido.setQuantidade(Integer
				.parseInt(JOptionPane.showInputDialog("Digite a quantidade de itens que você quer para esse pedido:")));
		pedido.setStatusPreparo(StatusPreparoPedido.SOLICIDADO);
	...
	public static Comanda cadastrarComanda() {
		...
		comanda.setObservacoes(JOptionPane.showInputDialog("Digite o nome da mesa:"));
	...
	public static String montarMenuPrincipal() {
		...
		builder.append("\n");
		builder.append("01 - Funcionario \n");
		builder.append("02 - Cliente \n");
		builder.append("03 - Produto \n");
		builder.append("04 - Cardapio \n");
		builder.append("05 - Mesa \n");
		builder.append("06 - Pedido \n");
		builder.append("07 - Sair \n");
	...
	public static String montarSubMenuGeral(String modulo) {
		...
		builder.append("=====================");
		builder.append("\n");
		builder.append("01 -Cadastrar ");
		builder.append("02 -Alterar ");
